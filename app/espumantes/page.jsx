...
import { espumantes } from "@/mock/espumantes";
import { Search } from "lucide-react";

export default function EspumantesPage () {
    const [search, setSearch] = useState ("");

    const filtered = espumantes.filter((item) =>
...
return (
    <div className="min-h-screen bg-[#F5F5F5] px-4 py-10">
        ...
        <h1 className="text-3l font-bold text-gray-900 mb-8 max-w-6xl mx-auto">
            Espumantes
            </h1>
