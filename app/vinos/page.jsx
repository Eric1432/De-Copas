...
return (
    <div className="min-h-screen bg-[#F5F5F5] px-4 py-10">
        ...
        {/* Titulo */}
        <h1 className="text-3xl font-blod text-gray-900 mb-8 max-w-6xl mx-auto">
            Vinos
            </h1>
            ...
            <div className="max-w-6xl mx-auto">
                <div className="bg-white border border-gray-300 rounded-xl px-5 py-3 flex items-center gap-3 shadow-sm transition focus-within:border-gray-400 focus-within:shadow-md">
                    ...
                    className="w-full bg-trasparent outline-none text-gray-700 placeholder:text-gray-400"
                    value={search}
